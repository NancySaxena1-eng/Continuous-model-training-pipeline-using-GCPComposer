...
def train_model(model_name, x_train, y_train):
    if model_name == 'logistic':
        ...
        model = SklearnXGBClassifier(random_state=42, use_label_encoder=False)
    else:
...
def write_metrics_to_bigquery(algo_name, training_time, model_metrics):
    ...
    table_id = "testmlops-446623.ml_ops.bank_campaign_model_metrics"
...
def main():
    input_data_path = "gs://mlops-test2/bank-additional.csv"
    model_name='xgboost'
